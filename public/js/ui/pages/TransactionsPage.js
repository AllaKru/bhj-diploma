...
class TransactionsPage {
  ...
  render(options) {
    ...
    if (!options) {
      ...
      Transactions.list(options, (e, response) => {
        if (response.success) {
  ...
  getTransactionHTML(item) {
    return `<div class="transaction transaction_${item.type.toUpperCase()} row">
  ...
  renderTransactions(data) {
    ...
    data.forEach(element => {
      this.element.querySelector(".content").insertAdjacentHTML
        ("beforeend", this.getTransactionHTML(item));
    });
  }
}
